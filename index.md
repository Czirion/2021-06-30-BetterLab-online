...
venue: "ENES León"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
<p>
We will use this <a href="{{https://pad.carpentries.org/2021-06-30-BetterLab}}">collaborative document</a> for chatting, taking notes, and sharing URLs and bits of code.
</p>
<hr/>
{% endif %}
